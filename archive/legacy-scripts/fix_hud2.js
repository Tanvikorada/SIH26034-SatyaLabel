...
if (startIdx !== -1 && endIdx !== -1) {
  const newLoadingState = `<div className="flex flex-col items-center justify-center min-h-[60vh] px-4 w-full max-w-4xl mx-auto my-8">
  ...
  console.log("HUD REPLACED VIA INDEX");
} else {
