...
old_dropzone = """                    <>
                       <div className="w-12 h-12 rounded-full bg-surface border border-border flex items-center justify-center text-text-muted mb-4 group-hover:scale-110 transition-transform shadow-sm">
...
new_dropzone = """                    <div className="flex flex-col items-center gap-4 relative z-10 w-full">
                       ...
                       <div className="flex gap-4 w-full justify-center">
                         ...
                         {/* Camera Button */}
                         <div className="relative overflow-hidden mello-btn-secondary !px-4 !py-3 flex flex-col items-center gap-2 hover:border-primary cursor-pointer w-[140px]">
                           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
                           <span className="text-[12px]">Take Photo</span>
