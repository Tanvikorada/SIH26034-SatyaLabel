...
const startIndex = js.indexOf('async function runBatchPipeline(batch, imagePath, metadata = {}) {');
const endIndex = js.indexOf('// OLD://  POST /api/v1/scans ');
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Replaced runBatchPipeline!");
} else {
