...
function TechStack() {
  return (
    <section className="py-24 px-6 max-w-6xl mx-auto border-t border-[var(--color-border)] relative z-10">
      ...
      <div className="mt-8 flex justify-center gap-6 text-xs text-[var(--color-text-secondary)] font-mono">
...
function StatCard({ number, label }) {
  return (
    <div className="flex flex-col items-center p-6">
      ...
      <span className="text-sm font-medium uppercase tracking-wider text-[var(--color-text-secondary)]">{label}</span>
    </div>
  );
}
        ...
        <section className="relative px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 z-10 mb-20">
          <div className="flex-1 max-w-xl">
            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}
              ...
              <Link href="/login" className="mello-btn-primary !px-8 !py-4 !text-[16px] shadow-[0_4px_20px_rgba(255,153,51,0.2)]">Launch Field Scanner</Link>
