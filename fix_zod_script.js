...
const replaceGemini = replaceGroq.replace(/    /g, '      '); // match indentation

if (js.includes(targetGemini.replace(/\r\n/g, '\n'))) {
  js = js.replace(targetGemini.replace(/\r\n/g, '\n'), replaceGemini);
} else if (js.includes(targetGemini)) {
  js = js.replace(targetGemini, replaceGemini);
}

if (js.includes(targetGroq.replace(/\r\n/g, '\n'))) {
  js = js.replace(targetGroq.replace(/\r\n/g, '\n'), replaceGroq);
} else if (js.includes(targetGroq)) {
