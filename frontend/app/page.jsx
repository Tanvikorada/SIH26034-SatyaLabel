...
import { 
  ...
  SiGoogle, SiGithub, SiPython, SiOpenai
} from 'react-icons/si';
      ...
      <div className="relative w-full max-w-[800px] mx-auto h-[400px] flex items-center justify-center">
         ...
         <div className="absolute inset-0 flex items-center justify-center z-10">
            ...
            <div className="absolute bottom-12 right-12 flex flex-col items-center gap-2 group cursor-help">
              <div className="w-14 h-14 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl flex items-center justify-center shadow-lg group-hover:border-[var(--color-primary)] transition-colors"><SiOpenai size={24} className="text-[#10a37f]" /></div>
