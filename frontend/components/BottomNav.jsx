...
export default function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-[#090a0f] border-t border-[var(--color-border)] pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
